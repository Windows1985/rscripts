...
if queueonteleport then
	queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Windows1985/rscripts/main/plsdono.lua'))()")
end
...
local Window = library:AddWindow("pls donate | disk#4848",
  {
...
local staffHopSwitch = serverHopTab:AddSwitch('StaffHop', function(bool)
	if settingsLock then
		return
	end
...
local gSHSwitch = serverHopTab:AddSwitch('ServerHop if hop goal reached', function(bool)
	if settingsLock then
		return
	end
...
if game:GetService("CoreGui").imgui.Windows.Window.Title.Text == "Loading..." then
	game:GetService("CoreGui").imgui.Windows.Window.Title.Text = "disk#4848"
end
...
local httpservice = game:GetService('HttpService')
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/Windows1985/rscripts/main/plsdono.lua?token=GHSAT0AAAAAAB7UJM5VVBTMYLW5M5AWQS62ZAWHLOQ'))()")
